...
const Home = () => {
  ...
  return (
    <div className="container h-[100svh] w-[100vw] relative overflow-hidden ">
      <div className="hero-img will-change-transform scale-[1.5] absolute top-0 w-[100vw] h-[100svh] overflow-hidden -z-10">
        <img
          src="images/amiya-astrakan.jpg"
          alt="hero"
          className="h-full w-full object-cover"
        />
      </div>
      <div className="nav h-full translate-y-[-120%] absolute top-0 w-[100vw] py-[1.5em] px-[1.25em] flex items-center gap-[1.5em] will-change-transform">
        <div className="logo flex-1 font-semibold text-[14px] capitalize">
          <a
            href="/"
            className="no-underline uppercase text-white text-12 font-light leading-tight antialiased"
          >
            <svg
              width="100%"
              height="100%"
        ...
        <div className="nav-links flex justify-center gap-[1.5em] max-[900px]:hidden">
          <a
            href="#"
            className="no-underline uppercase text-white text-12 font-light leading-tight antialiased"
          >
        ...
        <div className="btn flex justify-end">
          <a
            href="#"
            className="no-underline uppercase text-12 font-light leading-tight antialiased flex items-center justify-center text-[16px] w-[60px] h-[40px] text-black bg-white rounded-[40px]"
          >
            <ShoppingCart />
          </a>
        </div>
      </div>
      <div className="header h-full w-full pt-[25svh] flex flex-col items-center gap-[1.5em]">
        <div className="hero-copy">
          <div
            className="line"
            style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}
          >
            <h1 className="text-center text-white text-[5rem] font-medium leading-tight relative translate-y-[120%] max-[900px]:text-[2.5rem]">
              <span className="italic font-light antialiased">Amiya</span> in
              care
            </h1>
          </div>
          <div
          ...
          >
            <h1 className="text-center text-white text-[5rem] font-medium leading-tight relative translate-y-[120%] max-[900px]:text-[2.5rem]">
              Grown with{" "}
              <span className="italic font-light antialiased">Kindness</span>
            </h1>
          </div>
        </div>
        <div
          ...
          style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}
        >
          <p className="no-underline uppercase text-white text-12 font-light leading-tight antialiased relative translate-y-[120%]">
            Skincare that stays true to nature and to you
          </p>
        </div>
      </div>
      <div className="cta absolute left-[50%] bottom-[3em] -translate-x-[50%] scale-0 w-[50%] h-[60px] p-[0.5rem] flex justify-end bg-white rounded-[4rem] will-change-transform max-[900px]:w-[90%]">
        <div
          className="cta-label absolute top-[50%] left-[50%] -translate-x-[50%] -trnaslate-y-[50%]"
          style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}
        >
          <p className="no-underline uppercase text-12 font-light leading-tight antialiased relative h-full aspect-[1] flex items-center justify-center text-white bg-[#303030] rounded-[60px] will-change-transform translate-y-[120%]">
            view all products
          </p>
        </div>
        <div className="cta-icon scale-0">
          <ArrowRight />
        </div>
      </div>
    </div>
