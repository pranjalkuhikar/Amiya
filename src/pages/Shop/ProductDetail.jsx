          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                  ...
                  {product.sizes.map((size) => (
                    <motion.button
                      ...
                      className={`px-4 py-2 text-sm border ${
                        selectedSize === size
                          ? "border-indigo-600 bg-indigo-600 dark:bg-indigo-700 text-white"
                          : "border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-indigo-600 dark:hover:border-indigo-500"
            ...
            >
              <motion.button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-full font-medium relative overflow-hidden ${
                  product.available
